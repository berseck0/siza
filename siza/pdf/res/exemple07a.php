...
$rf2="select * from procesados where idana='$idan' and nom_anal='$nom_an' and folio='$fol' ORDER BY indianal ASC";
 $vrfko2=pg_query($conn, $rf2); 
while($nok2=pg_fetch_assoc($vrfko2)){
...
default:
if($nom_an==$vrd){
echo '<tr><td WIDTH="300" Align="left"><strong>&nbsp;&nbsp;&nbsp;&nbsp;'.$vrd.'</strong></td>';}	
	else{
echo '<tr><td WIDTH="300" Align="left">&nbsp;&nbsp;&nbsp;&nbsp;'.$vrd.'</td>';}
...
echo'<td WIDTH="150" align="right">(PROMEDIO</td><td WIDTH="80" >'.$max1.$unid.')</td></tr><br/>';
}else{
	
echo'<td WIDTH="150" align="right">'.$min.' -</td><td WIDTH="80" >'.$max1.''.$unid.'</td></tr><br/>';
	}
break;
case 57:
